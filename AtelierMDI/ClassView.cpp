...
/////////////////////////////////////////////////////////////////////////////
// Gestionnaires de messages de CClassView
...
int CClassView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	{
		TRACE0("Impossible de créer l'affichage de classes\n");
		return -1;      // échec de la création
	}

	// Charger les images :
	m_wndToolBar.Create(this, AFX_DEFAULT_TOOLBAR_STYLE, IDR_SORT);
	m_wndToolBar.LoadToolBar(IDR_SORT, 0, 0, TRUE /* Est verrouillé */);
...
{
	HTREEITEM hRoot = m_wndClassView.InsertItem(_T("Classes FakeApp"), 0, 0);
...
void CClassView::OnChangeVisualStyle()
{
	...
	m_wndToolBar.LoadBitmap(theApp.m_bHiColorIcons ? IDB_SORT_24 : IDR_SORT, 0, 0, TRUE /* Verrouillé */);
}
