...
{
	m_wndOutputBuild.AddString(_T("La sortie de la génération s'affiche ici."));
	m_wndOutputBuild.AddString(_T("La sortie s'affiche dans les lignes d'une vue Liste"));
	m_wndOutputBuild.AddString(_T("mais vous pouvez changer le mode d'affichage à votre guise..."));
}
