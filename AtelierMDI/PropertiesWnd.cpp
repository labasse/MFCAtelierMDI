...
void CPropertiesWnd::InitPropList()
{
	...
	CMFCPropertyGridColorProperty* pColorProp = new CMFCPropertyGridColorProperty(_T("Couleur de fenêtre"), RGB(210, 192, 254), nullptr, _T("Spécifie la couleur de fenêtre par défaut"));
